...
<div class="form">
    ...
    <form method="post" action="joinProcess.jsp" name="form_join">
        ...
        <div id="mail-check-result"></div><br>
        <div id="terms_of_use" style="width: 100%; height: 300px; overflow: auto;border: 1px solid gray; padding-left:10px" >
            <h2>이용약관</h2>
            <h3>
                <li>제1조(목적)</li>
            </h3>
            <p class="content">본 약관은 재활용마켓 (이하 “회사”라 합니다)가 제공하는 모바일 및 온라인 서비스(이하 “서비스”라 합니다)의 이용과 관련하여 회사와 회원 사이의 권리, 의무 및
                책임사항, 기타 제반사항을 규정함을 목적으로 합니다.</p>
            <h3>
                <li>제2조 (정의)</li>
            </h3>
            <p class="content">본 약관에서 사용하는 용어의 정의는 다음 각 호와 같으며, 정의되지 않은 본 약관상 용어의 해석은 관련 법령, 본 이용약관 및 서비스상 공지사항, 기타 일반적인 거래
                관행에 의합니다.</p>
            <ol>
                <li class="content">회원: 본 약관에 동의하고 회사와 서비스 이용계약을 체결하여 서비스를 이용하는 자를 말합니다.</li>
                <li class="content">판매자: 서비스에 물품(재화 또는 용역, 이하 같습니다)을 등록하여 판매하거나 판매할 의사로 서비스를 이용하는 회원을 말합니다. 다만, 회사가 특정 물품을
            ...
            <ol>
                ...
                <li class="content">회사는 전자상거래 등에서의 소비자보호에 관한 법률(이하 “전자상거래법”), 약관의 규제에 관한 법률(이하 “약관법”), 전자문서 및 전자거래기본법, 정보통신망
                    이용촉진 및 정보보호 등에 관한 법률(이하 “정보통신망법”), 소비자기본법 등 관련 법령을 위반하지 않는 범위 내에서 본 약관을 개정할 수 있습니다.
                </li>
                <li class="content">회사는 약관을 개정할 경우에 적용 일자, 개정 내용 및 개정 사유를 명시하여 그 적용 일자로부터 최소한 7일 이전부터 서비스 내 전자게시판에 공지합니다.
                    다만, 개정 약관의 내용이 회원에게 불리한 경우에는 개정 약관 적용 일자 30일 전부터 공지합니다.
                </li>
                <li class="content">회사가 전항에 따라 개정 약관을 공지하면서 ‘회원에게 개정 약관 시행일전까지 회원이 거부 의사를 표시하지 아니할 경우 회원이 개정 약관에 동의한 것으로 본다는
            ...
            <ol>
                <li class="content">회사는 개별 서비스에 대해서 별도의 이용약관 및 정책 등(이하 "개별 약관 등")을 수립할 수 있으며, 개별 서비스에 대한 내용이 본 약관과 상충할 경우에는
                    개별 약관 등이 우선하여 적용됩니다.
                </li>
                <li class="content">본 약관에 명시되지 않은 사항은 약관법, 전자상거래법, 정보통신망법, 전자상거래 등에서의 소비자보호지침(이하 "소비자보호지침") 등 관련 법령 또는 상관례에
                    따릅니다.
                </li>
            </ol>
            </ul>
